...
@Controller
@RequestMapping("/reseller/user")
public class ResellerUserController extends ControllerSupport<User, String, UserRepository> {
    ...
    public List<Role> getRoles() {
        return (List<Role>) roleRepository.findAll(QRole.role.category.eq("RESELLER"), true, QRole.role.name.asc());
    }
