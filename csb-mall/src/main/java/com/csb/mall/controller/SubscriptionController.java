...
public class SubscriptionController {
    ...
    @RequestMapping(value = "/saas/create", method = RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value = "/saas/status/{eventId}", method = RequestMethod.GET)
    @ResponseBody
    public ResponseEntity<?> getSaaSStatus(@PathVariable("eventId") String eventId) {
