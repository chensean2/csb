 ...
 * 
 */
public class DataTransferUserAdaptorServiceImpl extends BaseAdaptor implements
		AdaptorService {
	private static Logger log = LoggerFactory
			.getLogger(DataTransferUserAdaptorServiceImpl.class);

	public Map<String, Object> execute(Map<String, String> paraMap,
			Map<String, String> serviceMap) {
		Map<String, Object> responseMap = new HashMap<String, Object>();
		responseMap.put(IAppsConstants.ISV_ADAPTOR_RETURN_CODE,
				IAppsConstants.PROVISION_REQUEST_PROVISION_SUCCESS);
