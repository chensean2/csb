/*
 * =========================================================================
 * Program Name: com.saas.usercenter.command.CaptchaServiceSingleton.java
 *
 ...
 * v1.0     - Initial Release          Wu Ming Shan               Feb 16, 2011
 * =====================================================================================
 */
...
public class CaptchaServiceSingleton extends ListImageCaptchaEngine {
    private static Logger log = LoggerFactory.getLogger(CaptchaServiceSingleton.class);
