...
public class XmlDigitalSigner {
  ...
  private static Element signSamlElement(Element element, PrivateKey privKey,
      PublicKey pubKey) throws SCServiceException {
    ...
    try {
      ...
      throw new SCServiceException("Error signing SAML element: " + e.getMessage());
  ...
  public static String signXML(String samlResponse, PublicKey publicKey,
      PrivateKey privateKey) throws SCServiceException {
    Document doc = createJdomDoc(samlResponse);
    if (doc != null) {
      ...
      throw new SCServiceException("Error signing SAML Response: Null document");
    }
  }
